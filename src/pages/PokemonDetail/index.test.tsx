...
import { loadDetailPokemon } from "../../services/PokeomServices";
import { faker } from "@faker-js/faker";
import * as rrd from "react-router-dom";

const mockFn = vi.fn(loadDetailPokemon);
const mockFetchDetail = mockFn.mockImplementation(async () => {
  return {
    id: 1,
...
describe("Testa o component PokemonDetail", () => {
  ...
  test("Deve haver um título na página", async () => {
    render(<PokemonDetail loadDetailPokemon={mockFetchDetail} />);
